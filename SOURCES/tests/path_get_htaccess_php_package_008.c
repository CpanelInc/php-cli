/* ea-php-cli - tests/path_get_htaccess_php_package_008.c  Copyright 2017 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int main(int argc, char** argv) {
  ...
  printf("testing path_get_htaccess_php_package with php version 56 in /a/deep/.htaccess path for \"%s\"\n", testcase);
