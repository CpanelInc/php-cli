/* ea-php-cli - tests/path_get_htaccess_php_package_003.c  Copyright 2017 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int main(int argc, char** argv) {
  ...
  printf("testing path_get_htaccess_php_package with ea_php70 in .htaccess in directory of \"%s\"\n", testcase);
  ...
  if (get_from_file_called == 0) {
    ...
    printf("  htaccess_get_php_package_from_file_called\n");
  }
