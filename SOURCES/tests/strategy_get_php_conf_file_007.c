/* ea-php-cli - tests/strategy_get_php_conf_file_007.c  Copyright 2016 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int main(int argc, char** argv) {
  ...
  printf("testing strategy_get_php_conf_file with no cli_config set, stat on /etc/cpanel/ea4/php.conf failed, and paths_config.dirconf set to /etc/somewhere \n");
