/* ea-php-cli - tests/cli_get_last_file_007.c   Copyright 2016 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int __wrap_access(const char* pathname, int flags) {
    ...
    return (!strcmp("first", pathname) || !strcmp("third", pathname)) ?  0 : -1;
}
...
int main(int argc, char** argv) {
  ...
  printf("testing cli_get_last_file on \"first second third fourth\" where first and third are files\n");
