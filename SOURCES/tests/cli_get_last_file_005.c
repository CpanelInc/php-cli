/* ea-php-cli - tests/cli_get_last_file_005.c   Copyright 2016 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int __wrap_access(const char* pathname, int flags) {
    ...
    return strcmp("fourth", pathname) ? -1 : 0;
}
...
int main(int argc, char** argv) {
  ...
  char* expected_file = "fourth";

  printf("testing cli_get_last_file on \"first second third fourth\" where \"fourth\" is a file\n");
