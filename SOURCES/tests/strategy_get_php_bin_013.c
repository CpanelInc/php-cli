/* ea-php-cli - tests/strategy_get_php_bin_013.c  Copyright 2017 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int main(int argc, char** argv) {
  ...
  char* expected_php_bin = "/my/alternate/xx-php30/bin/php";
  ...
  printf("testing strategy_get_php_bin on php version \"xx-php30\" with "
         "empty bin_pattern and corresponding regular executable file\n");
