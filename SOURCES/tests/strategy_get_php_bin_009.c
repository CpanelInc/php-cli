/* ea-php-cli - tests/strategy_get_php_bin_009.c  Copyright 2017 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int main(int argc, char** argv) {
  ...
  strncpy(cli_config.php_bin_pattern, "%s/my/bin/%spattern",
          CLI_CONFIG_PHP_BIN_PATTERN_SIZE);

  printf("testing strategy_get_php_bin on php version \"\" with "
         "bin_pattern \"%%s/my/bin/%%spattern\" and corresponding "
