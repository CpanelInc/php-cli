/* ea-php-cli - tests/strategy_get_php_bin_015.c  Copyright 2017 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int main(int argc, char** argv) {
  ...
  char php_package[20] = "xx-php54";
  char php_bin[1024] = "junk";

  /* Assure empty php_bin_pattern */
  memset(cli_config.php_bin_pattern, 0, CLI_CONFIG_PHP_BIN_PATTERN_SIZE);

  printf("testing strategy_get_php_bin on php version \"xx-php54\" with "
         "empty bin_pattern which maps to a regular nonexecutable file\n");
