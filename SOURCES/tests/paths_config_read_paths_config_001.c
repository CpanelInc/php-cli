/* ea-php-cli - tests/paths_config_read_paths_config_001.c  Copyright 2016 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int main(int argc, char** argv) {
  struct paths_config* testcase = 0;
  char   file[1024] = "unset";
  int    return_code = 0;

  printf("testing paths_config_read_paths_config on null pointer\n");
  printf("  calling paths_config_read_paths_config(\"%s\", %d, (struct cli_config*)0)\n", file, 1024);

  return_code = paths_config_read_paths_config(file, 1024, testcase);
