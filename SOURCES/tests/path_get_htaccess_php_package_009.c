/* ea-php-cli - tests/path_get_htaccess_php_package_009.c  Copyright 2017 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int main(int argc, char** argv) {
  ...
  printf("testing path_get_htaccess_php_package with php version 56 in /a/.htaccess path and php verison 70 in /a/deep/.htaccess access path for \"%s\"\n", testcase);
