/* ea-php-cli - tests/path_get_htaccess_php_package_002.c  Copyright 2017 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int main(int argc, char** argv) {
  char  testcase[1024] = { 0 };
  char  version[8] = "junk";

  printf("testing path_get_htaccess_php_package on empty string\n");
