/* ea-php-cli - tests/htaccess_get_php_package_from_file_006.c  Copyright 2017 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int main(int argc, char** argv) {
  ...
  printf("testing htaccess_get_php_package_from_file on regular file that cannot be opened\n");
