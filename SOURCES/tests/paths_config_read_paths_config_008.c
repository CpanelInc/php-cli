/* ea-php-cli - tests/paths_config_read_paths_config_008.c  Copyright 2016 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int main(int argc, char** argv) {
  ...
  if (strncmp(paths_config.dir_logs, "logs", 1024) != 0) {
    printf("ERROR: paths_config.dir_logs \"%s\" is not \"logs\"\n", paths_config.dir_logs);
    return 1;
  } else {
    printf("  paths_config.dir_logs \"%s\" is set correctly to \"logs\"\n", paths_config.dir_logs);
  }
