/* ea-php-cli - tests/cli_config_read_cli_config_005.c  Copyright 2016 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int main(int argc, char** argv) {
  ...
  int expected_yaml_parser_parse_called_count = 2;

  printf("testing cli_config_read_cli_config on regular file, no contents\n");
