/* ea-php-cli - tests/cli_config_read_cli_config_008.c  Copyright 2016 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int __wrap_yaml_parser_parse(yaml_parser_t* parser, yaml_event_t* event) {
    ...
    yaml_char_t* event_values[] = { 0, 0, 0, 0, 0, 0 };
...
int main(int argc, char** argv) {
  ...
  int expected_yaml_parser_parse_called_count = 6;

  printf("testing cli_config_read_cli_config on regular file, containing one document containing an empty sequence\n");
