/* ea-php-cli - tests/cli_get_php_version_004.c  Copyright 2016 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int main(int argc, char** argv) {
  ...
  printf("testing cli_get_php_version on \"-ea_php 70\"\n");
  printf("  calling cli_get_php_version(\"%s\", %d, @{\"-ea_php\", \"70\", 0})\n",
         version, 8);
