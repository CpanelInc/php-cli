/* ea-php-cli - tests/path_get_htaccess_php_version_006.c  Copyright 2016 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int main(int argc, char** argv) {
  ...
  printf("testing path_get_htaccess_php_version with php version 56 in /.htaccess path for \"%s\"\n", testcase);
