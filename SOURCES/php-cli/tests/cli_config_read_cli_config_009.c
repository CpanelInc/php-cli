/* ea-php-cli - tests/cli_config_read_cli_config_009.c  Copyright 2016 cPanel, Inc. */
/*                                                     All rights Reserved. */
...
int main(int argc, char** argv) {
  ...
  printf("testing cli_config_read_cli_config on regular file, containing one document containing an empty mapping\n");
